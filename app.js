...
// To connect on MongoDB Atlas we use the connection below. (CLOUD)
// mongoose.connect('mongodb+srv://admin-mustafa:<password>@cluster0.feuuv.mongodb.net/<database name>', {useUnifiedTopology: true,useNewUrlParser: true});
